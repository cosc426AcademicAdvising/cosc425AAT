...
std_info = json.loads(infile_data)


std_name = std_info['student']['name']
std_id = str(std_info['student']['id'])
std_grad = str(std_info['student']['year'])

def year():
    for yr in std_info['student']['classification']:
        if std_info['student']['classification'][yr]:
            return yr
    return "blank"
